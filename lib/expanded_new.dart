    ...
    return Scaffold(
        ...
        body: Container(
            ...
            child: Column(
              ...
              children: [
                Text(category,
                    style: ManosFonts.overline(color: ManosColors.neutral0)),
                ...
                const SizedBox(height: 16),
                Text(body, style: ManosFonts.b1(color: ManosColors.neutral0)),
                const SizedBox(height: 16),
                Container(
                    alignment: Alignment.center,
                    child: Text("Comparte esta nota", style: ManosFonts.h2())),
                const SizedBox(height: 16),
                Container(
                    width: 1000,
                    alignment: Alignment.center,
                    ...
                    child: TextButton(
                        ...
                        child: Text(
                          "Compartir",
                          style:
                              ManosFonts.button(color: ManosColors.neutral100),
                        )))
              ],
            )));
  }
