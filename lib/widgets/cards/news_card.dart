...
class NewsCard extends StatelessWidget {
  final NewsModel nModel;

  const NewsCard({Key? key, required this.nModel}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Row(
          children: [
            Image.network(nModel.imageUrl, width: 118, fit: BoxFit.fitWidth),
            Expanded(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(nModel.category.toUpperCase(),
                        style: ManosFonts.overline()),
                    Text(
                      nModel.title,
                      style: ManosFonts.sub1(),
                    ),
                    Text(nModel.subtitle,
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => ExpandedNew(
                                          category: nModel.category,
                                          title: nModel.title,
                                          imageUrl: nModel.imageUrl,
                                          subtitle: nModel.subtitle,
                                          body:
